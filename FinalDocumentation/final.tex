...
However, the major change to our project, that of moving from Cloud Compare to PoTree Viewer, didn't change our design document much.
In fact the only manjor change was concerning the implementation of a UI to manipulate data, as PoTree Viewer lacked this functionality.
Other than that change, only the definition concerning CC and references to CC needed to be changed as the document was written such that any point-cloud viewing software could be used as the base.
