...
\begin{ganttchart}[
    ...
    \ganttbar[progress=100]{Requirements Document}{1}{3}\\
    \ganttbar[progress=100]{Technical Review}{2}{4}\\
    \ganttbar[progress=100]{Design Document}{2}{4}\\
    \ganttgroup{Implementation}{1}{12}\\
    \ganttbar[progress=50]{OpenGL OSVR Harness}{1}{4}\\
    \ganttbar[progress=75]{Research on Software}{4}{7}\\
    \ganttbar[progress=25]{Documentation}{7}{12}\\
    \ganttbar[progress=30]{Integration of OSVR and Software}{7}{12}\\
