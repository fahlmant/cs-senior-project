...
Shall have a user interface for interacting with the data

Shall render at least million points of cloud data

Shall be usable by any Virtual Reality headware and framework

Shall interface with the Cloud Compare software

Shall utilize an auxillery device for interaction with the data
